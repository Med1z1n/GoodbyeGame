...
class PongGame {
    ...
    handleNotification(event) {
        ...
        else if (value === "3") this.movePaddle(this.leftPaddle, this.paddleSpeed); // Left down
        else if (value.startsWith("2:")) this.movePaddle(this.rightPaddle, -this.paddleSpeed); // Right up
